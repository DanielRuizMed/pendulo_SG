...
class MyScene extends THREE.Scene {
  ...
  createGUI () {
    ...
    //var folder2 = gui.addFolder ('Controles de la Caja');
    // Estas lineas son las que añaden los componentes de la interfaz
    // Las tres cifras indican un valor mínimo, un máximo y el incremento
    // El método   listen()   permite que si se cambia el valor de la variable en código, el deslizador de la interfaz se actualice
    //folder2.add (this.guiControls, 'reso', 1, 360, 1).name ('Resolución : ').listen();
    //folder2.add (this.guiControls, 'angu', 0, 2*Math.PI, 0.1).name ('Ángulo : ').listen();
  ...
  update () {
    ...
    this.model.update(this.guiControls.reso,this.guiControls.angu);
  }
}